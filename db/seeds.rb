...
ITEMS = [
  ...
  # === Аксессуары ===
  {
    ...
    gender: "all", sizes: ["54–58 см"], material: "100% шерсть", color: "Чёрный",
  ...
  },
  {
    ...
    gender: "all", sizes: ["180 × 30 см"], material: "100% кашемир", color: "Бежевый",
    care_instructions: "Только химчистка",
  ...
  },
  {
    ...
    gender: "all", sizes: ["40 × 30 × 15 см"], material: "100% нейлон", color: "Чёрный",
