  ...
  return (
    <div className="max-w-md mx-auto my-8 p-8 bg-white rounded-lg shadow">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button type="submit" className="w-full bg-accent text-white py-2 rounded-md font-semibold">Войти</button>
      </form>
      <p className="mt-4 text-sm text-center">
        Нет аккаунта? <Link href="/register" className="text-accent hover:underline">Регистрация</Link>
      </p>
    </div>
  );
}
